...
description: >-
  Step-by-step guide to set up Visual Studio Code command line integration for
  both Terminal and Zsh on macOS.
summary: >-
  Using Visual Studio Code on OSX?  Here's how to set up the command line for
  Zsh or Terminal.
tags:
  - Visual Studio Code
  - macOS
...
categories:
  - Development
pubDate: '2020-04-07T13:27:04.000Z'
draft: false
---
