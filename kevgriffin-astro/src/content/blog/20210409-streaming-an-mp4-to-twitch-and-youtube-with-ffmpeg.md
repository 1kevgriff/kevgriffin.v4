...
description: >-
  Learn how to stream pre-recorded MP4 videos live to Twitch and YouTube using
  FFMPEG with proper RTMP configuration and settings.
summary: >-
  In this post, I discuss how I was able to 'stream' an MP4 LIVE to YouTube and
  Twitch using FFMPEG
tags:
  - FFMPEG
  - Streaming
...
categories:
  - Misc.
pubDate: '2021-04-09T11:00:00.000Z'
draft: false
---
