...
description: >-
  Fix SignalR AbortController undefined errors on older browsers like SmartTVs
  by implementing a workaround for missing fetch/AbortController support.
summary: >-
  Recently, I updated a client application to the latest versions of SignalR
  (including the NPM module). One of our users uses a SmartTV to view the page,
  and it stopped working due to 'AbortController is Undefined'.
tags:
  - SignalR
...
excerpt: >-
  ...
  (including the NPM module). One of our users uses a SmartTV to view the page,
  and it stopped working due to 'AbortController is Undefined'.
pubDate: '2021-03-03T11:00:00.000Z'
draft: false
---
