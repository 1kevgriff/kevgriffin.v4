...
description: >-
  Learn how to use .NET's ConnectionStringBuilder classes to create clean,
  flexible connection strings for OleDb, SQL Server, and Entity Framework.
summary: ConnectionStringBuilder makes it fool-proof to generate connection strings.
tags:
  - Development - C#
categories:
  - Development - C#
pubDate: '2011-02-14T05:00:02.000Z'
draft: false
---
