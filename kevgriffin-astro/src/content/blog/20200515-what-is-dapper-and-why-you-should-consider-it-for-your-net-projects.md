...
description: >-
  An introduction to Dapper, the micro-ORM that simplifies data mapping in .NET
  applications with better performance than Entity Framework.
summary: >-
  I have a pretty firm opinion that if you're using a relational database with
  .NET, you need to have Dapper in your stack.
tags:
  - .net
  - dotnet
  - asp.net
...
excerpt: >-
  I have a pretty firm opinion that if you're using a relational database with
  .NET, you need to have Dapper in your stack.
pubDate: '2020-05-15T09:30:00.000Z'
draft: false
---
