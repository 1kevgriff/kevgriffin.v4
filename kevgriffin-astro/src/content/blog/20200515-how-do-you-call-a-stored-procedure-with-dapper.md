...
description: >-
  Learn how to use Dapper with stored procedures in .NET applications, including
  both query and non-query scenarios.
summary: >-
  Are you interested in using Dapper, but your database uses Stored Procedures?
  No problem!
tags:
  - .NET
categories:
...
excerpt: >-
  Are you interested in using Dapper, but your database uses Stored Procedures? 
  No problem!
pubDate: '2020-05-15T08:30:00.000Z'
draft: false
---
