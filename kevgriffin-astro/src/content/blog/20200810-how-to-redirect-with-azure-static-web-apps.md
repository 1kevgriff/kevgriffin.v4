...
description: >-
  Learn how to implement 301 redirects in Azure Static Web Apps using the
  staticwebapp.config.json routing configuration file.
summary: >-
  When deploying to Azure Static Web Apps, a common question that comes up is
  'How do I do 301 redirects?'. Let's explore how in this simple tutorial.
tags:
...
categories:
  - Microsoft Azure
pubDate: '2020-08-11T00:30:00.000Z'
draft: false
---
