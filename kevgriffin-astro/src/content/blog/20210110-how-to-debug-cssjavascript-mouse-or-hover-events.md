...
description: >-
  How do you debug or style elements that only exist in the DOM during hover or
  mouse-over events?
summary: >-
  How do you debug or style elements that only exist in the DOM during hover or
  mouse-over events?
...
categories:
  ...
  - Web Development
excerpt: >-
  You're working on an issue the requires to debug or style an element on a page
  that ONLY appears in the course of a hover or mouse-over event.  However, when
  the event is not occurring, the element you want to work with does not exist
  in the DOM.
