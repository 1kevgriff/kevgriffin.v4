...
description: >-
  Learn how to check for and apply updates to your .NET CLI templates using
  simple dotnet commands introduced in .NET Core 3.0.
summary: >-
  How do you update the .NET CLI templates?  Turns out there is a command just
  for you!
tags:
  - .NET CLI
  - Templates
