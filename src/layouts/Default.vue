<template>
  ...
  >
    <header class="border-green-700 border-t-14">
      <nav
        class="container flex flex-wrap items-center justify-between py-8 mx-auto "
      >
        <div>
          <h1 class="text-2xl">
        ...
        >
          ...
          <li class="mb-6 mr-8 lg:mb-0">
            <g-link to="/articles" class="text-copy-primary hover:text-gray-600"
              >Articles</g-link
            >
          </li>
          <li class="mb-6 mr-8 lg:mb-0">
            <g-link to="/courses" class="text-copy-primary hover:text-gray-600"
              >Courses</g-link
            >
          </li>
          <li class="mb-6 mr-8 lg:mb-0">
            <g-link to="/contact" class="text-copy-primary hover:text-gray-600"
              >Contact</g-link
            >
          </li>
          <li class="mb-6 mr-8 lg:mb-0">
            <a
              ...
              class="p-2 text-white bg-green-700 border-2 rounded-lg text-copy-primary hover:bg-green-200 hover:text-black"
              target="_blank"
    ...
    <footer class="text-white bg-green-700">
      <div
        class="container flex flex-col items-center justify-between py-8 mx-auto lg:flex-row"
      >
        ...
        <ul class="flex items-center">
          <li class="mr-8">
            <a
              href="mailto:hello@consultwithgriff.com"
          ...
          <li class="mr-8">
            <a
              href="https://youtube.com/swiftkick"
              target="_blank"
              class="text-white hover:text-gray-400"
            >
              <svg
          ...
          <li class="mr-8">
            <a
              href="https://github.com/1kevgriff"
              target="_blank"
              class="text-white hover:text-gray-400"
            >
              <svg
          ...
          <li class="mr-8">
            <a
              href="https://twitter.com/1kevgriff"
              target="_blank"
              class="text-white hover:text-gray-400"
            >
              <svg
        ...
        grecaptcha.ready(() => {
          grecaptcha
            ...
            .then((token) => {
              ...
              axios
                .post(`${window.functionsUrl}ValidateSignalSignup`, payload)
                .then(
                  (res) => {
