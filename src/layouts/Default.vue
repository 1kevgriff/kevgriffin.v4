    ...
    <header class="border-green-700 border-t-14">
      ...
      >
        ...
        >
          ...
          <li class="mb-6 mr-8 lg:mb-0">
            <a
              href="https://calendly.com/1kevgriff/paid-60mins"
              class="border-2 rounded-lg p-2 bg-green-700 text-white text-copy-primary hover:bg-green-200 hover:text-black"
              target="_blank"
